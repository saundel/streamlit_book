...
:::{.callout-tip}
You can also use a relative path to point towards a csv that is stored locally - you will just need to ensure the csv is also supplied when *deploying* your final app.
